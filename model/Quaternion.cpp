...
web::json::value Quaternion::toJson() const
{
...
void Quaternion::fromJson(web::json::value& val)
{
    ...
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("w")];
        if(!fieldValue.is_null())
        {
            setW(ModelBase::doubleFromJson(fieldValue));
        }
    }
}

void Quaternion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Quaternion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    {
        setW(ModelBase::doubleFromHttpContent(multipart->getContent(utility::conversions::to_string_t("w"))));
    }
}
...
bool Quaternion::XIsSet() const
{
    return m_xIsSet;
}

void Quaternion::unsetx()
{
    m_xIsSet = false;
}
...
bool Quaternion::YIsSet() const
{
    return m_yIsSet;
}

void Quaternion::unsety()
{
    m_yIsSet = false;
}
...
bool Quaternion::ZIsSet() const
{
    return m_zIsSet;
}

void Quaternion::unsetz()
{
    m_zIsSet = false;
}
...
bool Quaternion::WIsSet() const
{
    return m_wIsSet;
}

void Quaternion::unsetw()
{
    m_wIsSet = false;
}
